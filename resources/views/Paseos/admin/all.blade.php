...
@section('content')
		...
		<div class="table-responsive">
			...
			return Button::primary('Editar '.$row['Nombre'])->asLinkTo(route('paseos.edit', $row['Id']))->block();
			})
			->callback('Borrar', function ($field, $row) {
			$return=Form::open(['class' => 'form-inline', 'method' => 'DELETE', 'route' => ['paseos.destroy', $row['Id']]]);
		...
		{!!Button::primary('Nuevo Paseo')->asLinkTo(route('paseos.create'))->block()!!}
